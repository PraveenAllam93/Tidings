...
class _BotState extends State<Bot> {
  ...
  void response(query) async {
    ...
    AuthGoogle authgoogle = await AuthGoogle(fileJson: "assets/usertidings-weawtp-855248a59f63.json").build();
    ...
    if(query.isNotEmpty && query != null){
        ...
        if(aiResponse.getListMessage()[00]["text"]["text"][0] == "You are redirecting to Recommendations."){
          setState(() {
            Fluttertoast.showToast(
                msg: "You are redirecting to Recommendations.",
